    ...
    <div>
     ...
     <Dropdown.Menu  variant="dark" className='dropdown'>
       ...
       <Navbar.Brand ><a href="https://firebasestorage.googleapis.com/v0/b/portafolio-b0d04.appspot.com/o/CV%20Juan%20Sebastian%20Suarez%20Ramirez%20(4).pdf?alt=media&token=d779eac8-360c-4628-9419-077d4d7b74c4" target="_blank" download="CV Juan Sebastian Suarez Ramirez" ><Button  className='dropdownlang'>Spanish</Button></a></Navbar.Brand></Dropdown.Item>
         ...
         :(<Navbar className='color' fixed="top" variant="dark"  expand="lg" >
         <Container fluid>
         <Dropdown>
         <Dropdown.Toggle id="dropdown-button-dark-example1" className='buttom' variant="Warning">
             Curriculum
           </Dropdown.Toggle>
       
           <Dropdown.Menu variant="dark" className='dropdown'> 
             <Dropdown.Item href="#/action-1" >
             <Navbar.Brand><a href="https://firebasestorage.googleapis.com/v0/b/portafolio-b0d04.appspot.com/o/CV%20Juan%20Sebastian%20Suarez%20Ramirez%20(3).pdf?alt=media&token=8fa06e58-4d9e-427a-9293-0a050da34e05" target="_blank" download="CV Juan Sebastian Suarez Ramirez" ><Button variant="secondary" className='dropdownlang'>English</Button></a></Navbar.Brand>
             </Dropdown.Item>
             <Dropdown.Item href="#/action-2"> 
             <Navbar.Brand><a href="https://firebasestorage.googleapis.com/v0/b/portafolio-b0d04.appspot.com/o/CV%20Juan%20Sebastian%20Suarez%20Ramirez%20(4).pdf?alt=media&token=d779eac8-360c-4628-9419-077d4d7b74c4" target="_blank" download="CV Juan Sebastian Suarez Ramirez" ><Button variant="secondary" className='dropdownlang'>Spanish</Button></a></Navbar.Brand></Dropdown.Item>
            
           </Dropdown.Menu >
           </Dropdown>
           <Navbar.Toggle aria-controls="navbar-dark-example" className='borderStyle'   />
           <Navbar.Collapse id="navbar-dark-example"  >
             <Nav className="module3"><center>
